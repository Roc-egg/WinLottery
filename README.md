...
| B5 移动核心端到端闭环 | 核心完成，待验收 | Android/iOS 已接入拍照/OCR 与手动录入两种入口、精确期号官网查询、本地规则计算、逐注结果、奖金终态、双源证据展示及保票据重试；两端模拟器已使用同一张实体票完成真实未中奖结果核对 | B2 正式对账与授权、足量真实票样、移动物理真机完整结果交互和发布窗口验收未完成 |
