...
| B5 移动核心端到端闭环 | 核心完成，待验收 | Android/iOS 已接入拍照/OCR 与手动录入两种入口、精确期号官网查询、本地规则计算、逐注结果、奖金终态、双源证据展示及保票据重试；两端模拟器已完成实体票真实未中奖、构造一等奖、未来期号安全阻断、最大辅助字号和断网恢复验收 | B2 双人复核、发布窗口和授权闸门，足量真实票样及移动物理真机完整结果交互仍未完成 |
