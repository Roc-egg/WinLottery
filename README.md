...
<div align="center">
  ...
  <p>
    ...
    <img alt="项目状态" src="https://img.shields.io/badge/status-V1.1%20completed-2f7d32">
...
更新日期：2026-08-25。当前移动端版本为 `1.1.0 (3)`，V1 与 V1.1 已完成关闭，当前没有已立项的在研版本。

| 状态 | 版本数量 | 当前范围 |
|---|---:|---|
| **已完成** | **2** | V1、V1.1 |
| **进行中** | **0** | 暂无；V1.2 尚未立项 |
| **未完成** | **4** | V1.2、V1.3、V1.4、V1.5 |
...
| V1.2 | **未完成** | 大乐透、双色球合法随机号码，支持期数和每期注数 | 已规划，待单独立项 |
...
暂无已立项的功能版本。项目处于 V1.1 完成后的稳定维护阶段；启动 V1.2 前，需要先冻结随机模式、期数与注数上限、领域约束和娱乐性文案。
